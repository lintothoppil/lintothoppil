...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Linto%20Mathew%20Joy&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full-Stack%20Developer%20%7C%20AI%20Enthusiast%20%7C%20Builder&descSize=16&descAlignY=55"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=16&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&width=620&lines=Hey+there%2C+I'm+Linto+Mathew+Joy+%F0%9F%91%8B;Full-Stack+Developer+%7C+AI+Enthusiast;Building+intelligent+apps+that+matter+%F0%9F%9A%80;From+resume+builders+to+exoplanet+detectors+%F0%9F%AA%90" alt="Typing SVG" />
...
&nbsp;
<a href="https://linkedin.com/in/linto-mathew-joy">
...
- 🏗️ Flask · React · Vite · Gemini AI · Google OAuth
...
> AI-Powered Resume Reviewer & Job Role Recommender *(v1)*
...
- 📡 Kepler · K2 · TESS light curve dataset
- ⚡ PyTorch · Flask web interface · HTML/CSS/JS
...
### 🚨 Rescue App
> Real-time Mobile Rescue App — Finalist, UST Global SIGHT 2.0

- 📍 GPS tracking & automated emergency alerts
- 📱 Real-time mobile app with REST API backend
- 🏆 Finalist — UST Global SIGHT 2.0 National Competition
- 🏗️ Flutter · Node.js · REST APIs
...
> Web App — Academic Project

- 👥 Member registration, attendance & subscriptions
- 💳 Payment management with normalized DB schema
- 🏗️ Django · MySQL
...
| 📜 Cloud & DevOps | Red Hat |
| 📜 Web Designing | Kondacy |
